                                    ...
                                    <tr v-if="tickets.data.length === 0">
                                        <td colspan="9" class="px-6 py-16 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-sm text-gray-500">You have no assigned tickets at the moment.</p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr v-for="ticket in tickets.data" :key="ticket.id" @click="viewMyTicket(ticket.id)" class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 cursor-pointer transition-all duration-200 border-l-4 border-transparent hover:border-indigo-500">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="bg-gradient-to-br from-violet-100 to-purple-100 p-2 rounded-lg mr-2">
