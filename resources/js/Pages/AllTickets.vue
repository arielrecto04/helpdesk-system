...
const getPersistedState = (key, defaultValue) => {
    const stored = localStorage.getItem(`allTicketsFilters_${key}`);
...
const toggleFilters = () => { 
    ...
    localStorage.setItem('allTicketsFilters_showFilters', JSON.stringify(showFilters.value));
};
...
watch([search, stageFilter, priorityFilter, teamFilter, assignedFilter, dateFrom, dateTo, deadlineFrom, deadlineTo, sortField, sortDirection], () => {
    localStorage.setItem('allTicketsFilters_search', JSON.stringify(search.value));
    localStorage.setItem('allTicketsFilters_stage', JSON.stringify(stageFilter.value));
    localStorage.setItem('allTicketsFilters_priority', JSON.stringify(priorityFilter.value));
    localStorage.setItem('allTicketsFilters_team', JSON.stringify(teamFilter.value));
    localStorage.setItem('allTicketsFilters_assigned', JSON.stringify(assignedFilter.value));
    localStorage.setItem('allTicketsFilters_dateFrom', JSON.stringify(dateFrom.value));
    localStorage.setItem('allTicketsFilters_dateTo', JSON.stringify(dateTo.value));
    localStorage.setItem('allTicketsFilters_deadlineFrom', JSON.stringify(deadlineFrom.value));
    localStorage.setItem('allTicketsFilters_deadlineTo', JSON.stringify(deadlineTo.value));
    localStorage.setItem('allTicketsFilters_sortField', JSON.stringify(sortField.value));
    localStorage.setItem('allTicketsFilters_sortDirection', JSON.stringify(sortDirection.value));
});
...
const applyFilters = debounce(() => {
    router.get(route('alltickets.index'), {
        search: search.value,
...
const executeBulkAction = () => {
    if (bulkAction.value === 'delete') {
        ...
        router.post(route('alltickets.bulk-delete'), {
        ...
        router.post(route('alltickets.bulk-update'), {
            ticket_ids: selectedTickets.value,
            updates: updates
        }, {
            onSuccess: () => {
