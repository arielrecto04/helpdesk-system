                ...
                <div class="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-2xl shadow-xl p-6">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex space-x-2" v-if="userPermissions && (userPermissions.includes('edit_teamtickets') || userPermissions.includes('delete_teamtickets'))">
                            <Link v-if="userPermissions.includes('edit_teamtickets')" :href="route('teamtickets.edit', ticket.id)" class="inline-flex items-center px-6 py-3 bg-white text-indigo-600 rounded-xl font-semibold text-sm shadow-lg hover:bg-blue-50 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                            ...
                            <DangerButton v-if="userPermissions.includes('delete_teamtickets')" @click="confirmTeamTicketDeletion" class="bg-white/20 text-white hover:bg-white/30 rounded-xl px-6 py-3">
                                Delete
                            </DangerButton>
                        </div>
                    </div>
