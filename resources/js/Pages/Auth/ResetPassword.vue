...
<template>
    <GuestLayout>
        <Head title="Reset Password — Innovato" />
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4 flex items-center justify-end">
                <PrimaryButton class="rounded-full bg-[#3BA3FF] px-6 py-2 text-[#0A1733]" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Reset Password
                </PrimaryButton>
            </div>
        </form>
