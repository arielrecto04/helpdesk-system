...
const tabs = [
    ...
    { name: 'Settings', type: 'dropdown', items: [{name: 'Helpdesk Team', href: '#'}, {name: 'Canned Responses', href: '#'}, {name: 'Employee', href: '#'}, {name: 'Customer', href: '#'}, {name: 'Department', href: '#'}, {name: 'Tags', href: '#'}]}
];
