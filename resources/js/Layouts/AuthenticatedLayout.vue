...
const tabs = [
    ...
    { name: 'Settings', type: 'dropdown', items: [{name: 'Helpdesk Team', href: route('helpdeskteams.index')}, {name: 'Canned Responses', href: '#'}, {name: 'Employee', href: route('employee.index')}, {name: 'Customer', href: '#'}, {name: 'Department', href: '#'}, {name: 'Tags', href: '#'}]}
];
